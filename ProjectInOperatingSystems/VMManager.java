...
public class VMManager {
    ...
    //         if (PM[i*2 + 1] != 0) {
    //             System.out.print("seg_" + i + ": ");
    //             for (int j = 0; j < 2; j++) {
    //                 System.out.print(PM[i*2 + j] + " ");
    //             }
    //             System.out.println("");
    //         }
    //     }
    ...
    //         int frame = PM[i*2 + 1]; // frame/block nums of each segment
    //         if (frame > 0) {
    //             System.out.print("pages of seg_" + i + ": ");
    //             int frameindex = frame * FRAMESZ;
    //             for (int j = frameindex; j < frameindex + FRAMESZ; j++) {
    //                 if (PM[j] > 0) {
    //                     System.out.print("m" + PM[j] + " ");
    //                 }
    //                 else if (PM[j] < 0) {
    //                     System.out.print("d" + Math.abs(PM[j]) + " ");
    //                 }
    //             }
    //             System.out.println("");
    //         }
    //         else if (frame < 0) {
    //             System.out.print("pages of seg_" + i + ": ");
    //             int blocknum = Math.abs(frame);
    //             for (int k = 0; k < BLOCKSZ; k++) {
    //                 if (Disk[blocknum][k] > 0) {
    //                     System.out.print("m" + Disk[blocknum][k] + " ");
    //                 }
    //                 if (Disk[blocknum][k] < 0) {
    //                     System.out.print("d" + Math.abs(Disk[blocknum][k]) + " ");
    //                 }
    //             }
    //             System.out.println("");
    //         }
    ...
    public int translateaddress(String address) {
        int pa;
        int va = Integer.parseInt(address);
        int s = va >> 18; // segment
